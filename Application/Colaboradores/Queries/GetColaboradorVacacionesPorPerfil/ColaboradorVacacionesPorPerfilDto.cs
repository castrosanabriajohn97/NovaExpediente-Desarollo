...
{
    public class ColaboradorVacacionesPorPerfilDto : IMapFrom<Colaborador>
    {


        public ColaboradorVacacionesPorPerfilDto()
        {
        }
        ...
        {
            profile.CreateMap<Colaborador, ColaboradorVacacionesPorPerfilDto>()
