...
{
    public class AsociarEmpresaColaboradorCommandValidator : AbstractValidator<AsociarEmpresaColaboradorCommand>
    {


        public AsociarEmpresaColaboradorCommandValidator()
        {
