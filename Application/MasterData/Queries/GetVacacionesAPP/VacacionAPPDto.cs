...
{
    public class VacacionAPPDto : IMapFrom<Vacacion>
    {
        ...
        public void Mapping(Profile profile)
        {
            ...
            profile.CreateMap<Vacacion, VacacionAPPDto>()
                ...
                .ForMember(d => d.Estado, opt => opt.MapFrom(s => s.SolicitudMasterData.ESTADOSOLICITUD == "AN" ? "Anulada" : "Aprobada"))
