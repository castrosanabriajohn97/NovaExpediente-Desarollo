...
{
    public class CertificacionConsultaDto : IMapFrom<Certificacion>
    {
        ...
        public void Mapping(Profile profile)
        {
            ...
            profile.CreateMap<Certificacion, CertificacionConsultaDto>()
                .ForMember(d => d.key, opt => opt.MapFrom(s => s.IDCERTIFICACION))
