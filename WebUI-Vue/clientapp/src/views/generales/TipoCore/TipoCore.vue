    ...
    <div class="wrapper vld-parent">
      <CRow>
        <CCol lg="12">
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong> Tipo de Core</strong>
              <small> Lista de Tipo de Core</small>
            </CCardHeader>
            <CCardBody>
              <DataTable
                ref="dt"
                ...
                dataKey="idTipoCore"
                :rowHover="true"
                :selection.sync="tipoCoreSeleccionado"
                :filters.sync="filters"
                :loading="loading"
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                :rowsPerPageOptions="[5, 10, 25, 50]"
                currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} Tipo de Core"
                sortField="nombre"
                :sortOrder="1"
                stateKey="dt-state-tipoCore"
              ...
              >
               ...
               <CRow>
                ...
                <template #empty> No se encontraron tipos de core. </template>
                <template #loading>
                  Cargando la información de tipos de core. Por favor espere.
                </template>
                <Column
                  field="Nombre"
                  header="Nombre"
...
<script>
import { GetTipoCore } from "./request";
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.tipoCores = tiposCores.map(({ idTipoCore, nombre, descripcion }) => ({
