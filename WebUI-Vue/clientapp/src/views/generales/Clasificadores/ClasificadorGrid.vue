          ...
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong>
               Clasificador</strong
              >
              <small> Lista de clasificadores</small>
            </CCardHeader>
            <CCardBody>
              <DataTable
                ref="dt"
                ...
                dataKey="id"
                :rowHover="true"
                :selection.sync="clasificadorSeleccionado"
                :filters.sync="filters"
                :loading="loading"
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                :rowsPerPageOptions="[5, 10, 25, 50]"
                currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} clasificadores"
                sortField="nombre"
                :sortOrder="1"
                stateKey="dt-state-clasificador"
              ...
              >
                ...
                <template #loading>
                  Cargando la información de clasificadores. Por favor
                  espere.
                </template>
                <Column
                  field="Nombre"
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.clasificadores = clasificadores.map(
