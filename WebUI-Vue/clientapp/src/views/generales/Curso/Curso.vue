    ...
    <div class="wrapper vld-parent">
      <CRow>
        <CCol lg="12">
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong> Curso</strong>
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.cursos = cursos.map(({ idCurso, nombre, descripcion }) => ({
        idCurso: idCurso,
        nombre: nombre,
