    ...
    <div class="wrapper vld-parent">
      <CRow>
        <CCol lg="12">
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong> Especialidad</strong>
              <small> Lista de especialidades</small>
            </CCardHeader>
            <CCardBody>
              <DataTable
                ref="dt"
                ...
                :rowHover="true"
                :selection.sync="especialidadSeleccionado"
                :filters.sync="filters"
                :loading="loading"
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                :rowsPerPageOptions="[5, 10, 25, 50]"
                currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} especialidades"
                sortField="nombre"
                :sortOrder="1"
                stateKey="dt-state-especialidad"
              ...
              >
                ...
                <template #loading>
                  Cargando la información de especialidades. Por favor espere.
                </template>
                <Column
                  field="Nombre"
                  header="Nombre"
...
<script>
import { GetEspecialidad } from "./request";
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.especialidades = especialidades.map(({ idespecialidad, nombre, descripcion }) => ({
