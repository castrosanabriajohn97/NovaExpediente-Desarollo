    ...
    <div class="wrapper vld-parent">
      <CRow>
        <CCol lg="12">
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong> Bases de Datos</strong>
            ...
            <CCardBody>
              <DataTable
                ...
                dataKey="idbasedatos"
                :rowHover="true"
                :selection.sync="baseDatosSeleccionado"
                :filters.sync="filters"
                :loading="loading"
                paginatorTemplate="FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink CurrentPageReport RowsPerPageDropdown"
                :rowsPerPageOptions="[5, 10, 25, 50]"
                currentPageReportTemplate="Mostrando del {first} al {last} de {totalRecords} bases de datos"
                sortField="nombre"
                :sortOrder="1"
                stateKey="dt-state-basesDatos"
              ...
              >
                ...
                <template #empty> No se encontraron bases de datos. </template>
                <template #loading>
                  Cargando la información de bases de datos. Por favor espere.
                </template>
                <Column
                  field="Nombre"
                  header="Nombre"
...
<script>
import { GetBaseDatos } from "./request";
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.basesDatos = basesDatos.map(({ idbasedatos, nombre, descripcion,versiones }) => ({
