    ...
    <div class="wrapper vld-parent">
      <CRow>
        <CCol lg="12">
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong> Puesto</strong>
            ...
            <CCardBody>
              <DataTable
                ...
                dataKey="idPuesto"
                :rowHover="true"
                :selection.sync="puestoSeleccionado"
              ...
              >
                ...
                <template #empty> No se encontraron puestos. </template>
                <template #loading>
                  Cargando la información de puestos. Por favor espere.
                </template>
                <Column
                  field="Nombre"
                  header="Nombre"
...
export default {
  ...
  methods: {
    async cargarTabla() {
      ...
      this.puesto = puesto.map(({ idPuesto, nombre, descripcion }) => ({
        idPuesto: idPuesto,
        nombre: nombre,
