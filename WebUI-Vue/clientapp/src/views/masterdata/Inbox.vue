    ...
    <div>
      ...
      <CCard style="border-radius: 16px !important; margin-top: 20px">
        <CCardHeader
          ...
          "
        >
          <strong>Mi buzón</strong>
        </CCardHeader>
        <CCardBody style="padding-top: 0px; padding-bottom: 0px">
          <p>Lista de solicitudes de cambio pendientes.</p>
        </CCardBody>
      </CCard>
      <CRow class="mt-1">
          ...
          <CRow>
            <CCol lg="12">
              ...
              >
                <template #header>
                  <CRow>
                    <CCol md="8" sm="12" class="mb-1"> </CCol>
...
import { GetSolicitudesPorPerfil, GetSolicitudesBuzon } from "./request";
...
export default {
  ...
  methods: {
    ...
    mostrarSolicitud(datosSolicitud) {
      // carga el formulario según el tipo de solicitud
      console.log(datosSolicitud,'srrINBOX');
      this.cargarSolicitud(
        this.obtenerObjetoCargarSolicitud(
    ...
    async cargarDatos() {
      ...
      await inbox
        ...
        .then(function (result) {
          ...
          root.infoColaboradorActual.contadorInbox = result.data.count;
          root.refreshInboxCounter();
