...
<template>
  <div>
    ...
    <CCard style="border-radius: 16px !important;">
      ...
      >
        <strong> Asignar colaborador como delivery manager</strong>
    ...
    <CCard style="border-radius: 16px !important;">
      <CCardHeader
        style="border-radius: 16px !important; border-bottom: transparent !important; background-color: #FFFFFF;"
      >
        <strong> El colaborador es delivery manager?</strong>
      </CCardHeader>
      <CCardBody>
        <FormulateForm
          v-model="solicitud"
              ...
              <CRow>
                <CCol sm="12" class="align-self-center">
                  <FormulateInput
                    ...
                    validation-name="Colaborador DM"
                    class="hint"
  ...
  methods: {
        ...
        case "Colaboradores":
          ...
          this.dataPickList = colaboradores.map(
            ({
              ...
              foto: foto,
              esdeliverymanager: esdeliverymanager
            })
          );
    ...
    async cargarDetalleColaborador(id, fromJson) {
      ...
      this.colaborador = {
        ...
        segundoapellido: colaborador.segundoapellido,
        foto: colaborador.foto,
        esdeliverymanager: colaborador.esdeliverymanager == true ? "Si" : "No"
      };
      if (!fromJson) {
        this.solicitud.esDM =
          colaborador.esdeliverymanager == true ? "Si" : "No";
      }
