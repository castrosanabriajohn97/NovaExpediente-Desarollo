  ...
  <div>
    <div class="">
      ...
      >
        ...
        <small>Listado de Convenios</small>
      </CCard>
...
<script>
import ListaConvenios from "./ListaConvenios.vue";
import FormConvenios from "./FormConvenios.vue";
...
export default {
  ...
  mixins: [common],
  components: {
    "lista-convenios": ListaConvenios,
    "form-convenios": FormConvenios,
  },
  data() {
    return {
      convenioId: null,
      loading: true,
      renderType: "lista-convenios",
      formAction: "",
    };
  },
  async mounted() {
  ...
  methods: {
    receiveId(value) {
      ...
      if (this.convenioId !== null) {
        this.renderType = "form-convenios";
      }
    },
    edit(value) {
