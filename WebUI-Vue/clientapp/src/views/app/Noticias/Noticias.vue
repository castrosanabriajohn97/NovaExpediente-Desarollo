...
import FormNoticias from "./FormNoticias.vue";
...
export default {
  ...
  mixins: [common],
  components: {
    "lista-noticias": ListaNoticias,
    "form-noticias": FormNoticias,
  },
  data() {
    return {
      selectedNewId: null,
      loading: true,
      renderType: "lista-noticias",
      formAction: "",
    };
  },
  async mounted() {
  ...
  methods: {
    receiveId(value) {
      ...
      this.selectedNewId = value;
      if (this.selectedNewId !== null) {
        this.renderType = "form-noticias";
      }
    },
    editNew(value) {
