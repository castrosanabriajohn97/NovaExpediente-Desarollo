          ...
          <CCard>
            <CCardHeader>
              <CIcon name="cil-justify-center" /><strong>
                Carga de incapacidades</strong
              >
              <small> Lista de archivos procesados</small>
    ...
    async cargarTabla() {
      ...
      this.incapacidades = cargas.map(
        ({
          ...
          fechaCarga: moment(fechaCarga).format("LL"),
