...
<template>
  <div>
    ...
    <CCard style="border-radius: 16px !important;">
      ...
      >
        <strong> Registro de incapacidades</strong>
        ...
        >
          <CRow>
            <CCol sm="1" class="align-self-center text-center">
              <img
                src="/img/icono-boleta-incapacidad.png"
            ...
            <CCol sm="5">
              <FormulateInput
                ...
                validation-name="Número de la boleta"
            ...
            <CCol sm="5">
              <FormulateInput
                ...
                :options="{
                  //  0: 'Seleccione un tipo de incapacidad',
                  E: 'Enfermedad',
                  M: 'Maternidad',
                  P: 'Paternidad'
                }"
                type="select"
                placeholder="Seleccione un tipo de incapacidad"
                label="Tipo de incapacidad"
                :input-class="['form-control']"
                validation="required|not:0"
                validation-name="Tipo de incapacidad"
                :validation-messages="{
                  required: 'Seleccione un tipo de incapacidad.',
          ...
          <CRow>
            ...
            <CCol sm="5">
              ...
              <FormulateInput
                ...
                class="hint"
                tipo-documento="Boleta incapacidad"
                :estado-solicitud="datosSolicitud.estadoSolicitud"
                :eliminada="false"
                :visor-padre="false"
                :habilitar-controles="
            ...
            <CCol sm="5" class="mt-1">
              <FormulateInput
                ...
                validation-name="Número de placa"
                :input-class="['form-control']"
                :disabled="!puedePintar"
              />
            </CCol>
          ...
          <CRow style="margin-bottom: 20px;">
            ...
            <CCol sm="10">
              <FormulateInput
                ...
                label="Indique alguna descripción adicional sobre la solicitud de incapacidad requerida"
  ...
  methods: {
    ...
    async procesarAccion_Denegar(accion) {
      let opciones = {
        ...
        mensajeDialogo:
          "Registre una justificación para denegar la solicitud de incapacidades",
        btnOk: "Denegar",
        btnCancel: "Cancelar",
        mensajeExito: "Solicitud denegada.",
        mensajeError:
          "Se ha presentado un inconveniente al denegar la solicitud de incapacidades."
      };
      await this.enviarSolicitud(accion, opciones);
    },
    async procesarAccion_Aprobar(accion) {
      let opciones = {
        ...
        titulo: "Solicitud administrativa",
        mensajeDialogo: "Está seguro de aprobar la solicitud de incapacidades?",
        btnOk: "Si",
        btnCancel: "No",
        mensajeExito: "Solicitud aprobada.",
        mensajeError:
          "Se ha presentado un inconveniente al aprobar la solicitud de incapacidades."
      };
      await this.enviarSolicitud(accion, opciones);
    },
      ...
      try {
        if (this.solicitud.estado == common.SOLICITUD_SINMODIFICACIONES) {
          ...
          if (this.solicitud.cantDias == 0) {
            Vue.$toast.error(
              "La solicitud debe contener al menos un día de incapacidades.",
              {}
            );
          } else if (
            this.solicitud.boleta == null ||
            this.solicitud.boleta == ""
          ) {
            Vue.$toast.error("Debe de ingresar el archivo de la boleta.", {});
          } else if (
            moment(this.solicitud.fechaInicio) >
            moment(this.solicitud.fechaFinal)
          ) {
            Vue.$toast.error(
