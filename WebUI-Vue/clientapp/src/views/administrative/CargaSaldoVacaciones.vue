...
<!-- Plantilla de Carga de vacaciones -->
<template>
  <div>
    <CCard>
      <CCardHeader>
        <CIcon name="cil-justify-center" /><strong>
          Cargar archivo de saldo de vacaciones</strong
        >
      ...
      <CCardBody>
        ...
        >
          ...
          <CRow>
            <CCol sm="6">
              <label>Archivo de saldo de vacaciones</label>
              <FormulateInput
                type="myfileupload"
                name="archivo"
                ...
                class="hint"
                tipo-documento="Archivo de vacaciones"
                estado-solicitud="RE"
                :eliminada="false"
                :visor-padre="false"
      ...
      <CRow class="pt-2">
        <CCol sm="12" lg="12" class="pull-right">
          ...
          >
            ...
            <template #empty>
              No se encontraron cargas de vacaciones.
            </template>
            <template #loading>
              Cargando la información de cargas de vacaciones. Por favor
              espere.
            </template>
        ...
        if (!this.visorEnable) {
          ...
          if (resultadoValidacion.esValido) {
            const res = await this.Confirmacion_Generico(
              "Desea cargar el archivo de vacaciones",
              "Carga de vacaciones"
            );
            var result = "";
