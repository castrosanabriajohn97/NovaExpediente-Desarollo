...
<template>
  <div>
    <TabView>
      ...
      <TabPanel v-if="esRRHH()" header="Saldo de vacaciones">
        <consulta-saldo-vacaciones></consulta-saldo-vacaciones>
      </TabPanel>
        <TabPanel v-if="esRRHH()" header="Esquema de vacunación">
        <consulta-vacunacion></consulta-vacunacion>
      </TabPanel>
      <TabPanel header="Saldo de colaboradores">
        <consulta-saldo-vacaciones-colaboradores ></consulta-saldo-vacaciones-colaboradores>
      </TabPanel>
    </TabView>
  </div>
</template>
...
import ConsultaSaldoVacaciones from "./ConsultaSaldoVacaciones.vue";
import ConsultaVacunacion from "./ConsultaVacunacion.vue"
import ConsultaSaldoVacacionesColaboradores from "./ConsultaSaldoVacacionesColaboradores.vue";
...
export default {
  ...
  components: {
    ...
    "consulta-saldo-vacaciones": ConsultaSaldoVacaciones,
    "consulta-vacunacion": ConsultaVacunacion,
    "consulta-saldo-vacaciones-colaboradores": ConsultaSaldoVacacionesColaboradores
  },
  data() {
    return {
      vacaciones: [],
