...
<template>
  <div>
    ...
    <CCard style="border-radius: 16px !important;">
      ...
      >
        <strong> Constancia de Salario</strong>
          ...
          <CRow style="margin-bottom: 20px;">
            ...
            <CCol sm="11">
              <FormulateInput
                ...
                type="textarea"
                rows="3"
                label="Indique alguna descripción adicional sobre la constancia salarial requerida"
  ...
  methods: {
    ...
    async procesarAccion_Denegar(accion) {
      let opciones = {
        ...
        mensajeDialogo:
          "Registre una justificación para denegar la constancia salarial",
        btnOk: "Denegar",
        btnCancel: "Cancelar",
        mensajeExito: "Solicitud denegada.",
        mensajeError:
          "Se ha presentado un inconveniente al denegar la constancia salarial."
      };
      await this.enviarSolicitud(accion, opciones);
    },
    async procesarAccion_Aprobar(accion) {
      let opciones = {
        ...
        titulo: "Solicitud administrativa",
        mensajeDialogo: "Está seguro de aprobar la constancia salarial?",
        btnOk: "Si",
        btnCancel: "No",
        mensajeExito: "Solicitud aprobada.",
        mensajeError:
          "Se ha presentado un inconveniente al aprobar la constancia salarial."
      };
      await this.enviarSolicitud(accion, opciones);
    },
