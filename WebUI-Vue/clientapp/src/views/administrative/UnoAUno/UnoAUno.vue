...
<template>
  <div>
    <div class="">
      ...
      >
        <strong>Listado de Uno a Uno</strong>
        <small>Colaboradores por DM</small>
      </CCard>
...
<script>
import ListaUnoAUno from "./ListaUnoAUno.vue";
import FormUnoAUno from "./FormUnoAUno.vue";
...
export default {
  ...
  mixins: [common],
  components: {
    "lista-unoauno": ListaUnoAUno,
    "form-unoauno": FormUnoAUno,
  },
  data() {
    return {
      idUnoAUno: null,
      loading: true,
      renderType: "lista-unoauno",
      formAction: "",
    };
  },
  async mounted() {
  ...
  methods: {
    receiveId(value) {
      ...
      this.idUnoAUno = value;
      if (this.idUnoAUno !== null) {
        this.renderType = "form-unoauno";
      }
    },
    edit(value) {
