...
<template>
  <div>
    ...
    <CCard style="border-radius: 16px !important;">
      ...
      >
        <strong> Carta de restricción vehicular</strong>
        ...
        >
          <CRow>
            <CCol sm="1" class="align-self-center text-center">
              <img
                src="/img/icono-restriccion-vehicular.png"
            ...
            <CCol sm="5">
              <FormulateInput
                name="numeroPlaca"
                label="Indique el número de placa del vehículo."
                placeholder="Número de placa"
                validation="required|max:20,length"
                validation-name="Número de placa"
                :validation-messages="{
                  required: 'Debe indicar un número de placa ',
          ...
          <CRow>
            ...
            <CCol sm="5">
              <FormulateInput
                ...
                type="textarea"
                rows="3"
                label="Indique la dirección de origen"
                placeholder="Dirección de origen"
                validation="required|max:500,length"
                validation-name="Dirección de origen"
                :validation-messages="{
                  required: 'Debe indicar una Dirección de origen ',
                  not: 'Debe de seleccionar una opción válida.'
                }"
                :input-class="['form-control']"
                :disabled="!this.puedePintar"
            ...
            <CCol sm="5">
              <FormulateInput
                ...
                type="textarea"
                rows="3"
                label="Indique la dirección de destino"
                placeholder="Dirección de destino"
                validation="required|not:0"
                validation-name="Dirección de destino"
                :validation-messages="{
                  required: 'Debe indicar una dirección de destino ',
                  not: 'Debe de seleccionar una opción válida.'
                }"
                :input-class="['form-control']"
                :disabled="!this.puedePintar"
          ...
          <CRow style="margin-bottom: 20px;">
            ...
            <CCol sm="10">
              <FormulateInput
                ...
                type="textarea"
                rows="3"
                label="Indique alguna descripción adicional sobre la carta de restricción vehícular requerida"
  ...
  methods: {
    ...
    async procesarAccion_Denegar(accion) {
      let opciones = {
        ...
        mensajeDialogo:
          "Registre una justificación para denegar la carta de restricción",
        btnOk: "Denegar",
        btnCancel: "Cancelar",
        mensajeExito: "Solicitud denegada.",
        mensajeError:
          "Se ha presentado un inconveniente al denegar la carta de restricción."
      };
      await this.enviarSolicitud(accion, opciones);
    },
    async procesarAccion_Aprobar(accion) {
      let opciones = {
        ...
        titulo: "Solicitud administrativa",
        mensajeDialogo: "Está seguro de aprobar la carta de restricción?",
        btnOk: "Si",
        btnCancel: "No",
        mensajeExito: "Solicitud aprobada.",
        mensajeError:
          "Se ha presentado un inconveniente al aprobar la carta de restricción."
      };
      await this.enviarSolicitud(accion, opciones);
    },
