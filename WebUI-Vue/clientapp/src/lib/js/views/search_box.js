...
VS.ui.SearchBox = Backbone.View.extend({
  ...
  value : function(query, jsonQuery) {
    if (query == null) return this.serialize();
    return this.setQuery(query, jsonQuery);
  },
  ...
  setQuery : function(query, jsonQuery) {
    this.currentQuery = query;
    VS.app.SearchParser.parse(this.app, query, jsonQuery);
  },
  ...
  clearSearch : function(e) {
    ...
    document.getElementById("btnBuscarColaboradoresConsulta").click();
  },
